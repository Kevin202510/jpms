                ...
                <div class="row justify-content-between">
                    ...
                    <div class="col-xl-7 col-lg-8">
                        ...
                        <div class="single-job-items mb-50">
                            ...
                            <div class="job-items">
                            <div class="company-img">
                            <a><img id="job_company_logoz" alt="" width="100" height="100"></a>
                            </div>
                    ...
                    <div class="col-xl-4 col-lg-4">
                        <div class="post-details3  mb-50">
                         ...
                         <button type="button" data-id="<?php echo $data['jobs_id']; ?>" class="btn btn-primary" style="color:fff; border:none;" id="apply_jobs">Apply Now</button>
                         </div>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="POST">
                                ...
                                <a href="index.php" style="border-radius:20px;  margin-right:150px;" type="submit" class="btn" >Please LogIn</a>
...
$.post("admin panel/update_jobs.php",{USER_IDsss: USER_IDss},function(data,status){
    ...
    $("#job_company_logoz").attr("src",logo);
